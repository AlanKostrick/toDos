...
function navToDos() {
  ...
  toDosButton.addEventListener('click', function () {
    _apiActions.default.getRequest('https://localhost:44326/api/todos', function (toDos) {
...
function navValues() {
  ...
  valueButton.addEventListener('click', function () {
    _apiActions.default.getRequest('https://localhost:44326/api/values', function (values) {
      document.querySelector('#app').innerHTML = (0, _Values.default)(values);
    });
  });
}
},{"./components/Header":"js/components/Header.js","./components/Footer":"js/components/Footer.js","./components/Home":"js/components/Home.js","./components/ToDos":"js/components/ToDos.js","./components/Values":"js/components/Values.js","./api/api-actions":"js/api/api-actions.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
